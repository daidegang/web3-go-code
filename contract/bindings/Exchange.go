...
//
// Solidity: event LogCancel(address indexed make, address indexed feeeRecipient, address makerToken, address takerToken, uint256 cancelledMakerTokenAmount, uint256 cancelledTakerTokenAmount, bytes32 indexed tokens, bytes32 orderHash)
func (_Exchange *ExchangeFilterer) FilterLogCancel(opts *bind.FilterOpts, arg0 []common.Address, feeeRecipient []common.Address, tokens [][32]byte) (*ExchangeLogCancelIterator, error) {

	var arg0Rule []interface{}
	for _, arg0Item := range arg0 {
		arg0Rule = append(arg0Rule, arg0Item)
	}
	var feeeRecipientRule []interface{}
	for _, feeeRecipientItem := range feeeRecipient {
		feeeRecipientRule = append(feeeRecipientRule, feeeRecipientItem)
	}
	...
	logs, sub, err := _Exchange.contract.FilterLogs(opts, "LogCancel", arg0Rule, feeeRecipientRule, tokensRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event LogCancel(address indexed make, address indexed feeeRecipient, address makerToken, address takerToken, uint256 cancelledMakerTokenAmount, uint256 cancelledTakerTokenAmount, bytes32 indexed tokens, bytes32 orderHash)
func (_Exchange *ExchangeFilterer) WatchLogCancel(opts *bind.WatchOpts, sink chan<- *ExchangeLogCancel, arg0 []common.Address, feeeRecipient []common.Address, tokens [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Exchange.contract.WatchLogs(opts, "LogCancel", arg0Rule, feeeRecipientRule, tokensRule)
	if err != nil {
		return nil, err
	}
